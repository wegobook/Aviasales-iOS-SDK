@objc extension StringUtils {
    ...
    static func propertyTypeAndRoomsCount(hotel: HDKHotel) -> String {
        ...
        return [propertyTypeString, roomsCountString].compactMap { $0 }.joined(separator: ", ")
    }
    ...
    static func attributedRangeValueText(currency: HDKCurrency,
        ...
        result.addAttributes(textStyle, range: NSRange(location: 0, length: str.count))
    ...
    @nonobjc static func offersString(withCount count: Int?) -> String {
